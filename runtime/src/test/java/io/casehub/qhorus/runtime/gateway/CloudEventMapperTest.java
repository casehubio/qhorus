...
class CloudEventMapperTest {
    ...
    void mapsMessageReceivedEventToCloudEvent() {
        ...
        MessageReceivedEvent event = new MessageReceivedEvent(
                ...
                MessageType.STATUS, "agent-1", null, null, "corr-1", now, "hello", null, "general");
    ...
    void omitsTenancyExtensionWhenNull() {
        ...
        MessageReceivedEvent event = new MessageReceivedEvent(
                ...
                MessageType.QUERY, "agent-1", null, null, null, Instant.now(), "q", null, null);
    ...
    void handlesEventTypeWithNullContent() {
        ...
        MessageReceivedEvent event = new MessageReceivedEvent(
                ...
                MessageType.EVENT, "agent-1", null, null, null, Instant.now(), null, null, null);
    ...
    void usesMessageIdAsCloudEventId() {
        ...
        MessageReceivedEvent event = new MessageReceivedEvent(
                ...
                MessageType.STATUS, "agent-1", null, null, null, Instant.now(), "hello", null, null);
