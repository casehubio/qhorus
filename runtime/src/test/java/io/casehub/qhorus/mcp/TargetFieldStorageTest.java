...
class TargetFieldStorageTest {
    ...
    void nullTargetIsStoredAsNullInResult() {
        ...
        DispatchResult result = tools.sendMessage("tgt-null-1", "alice", "status", "msg", null, null, null, null, null, null, null, null, null);
    ...
    void blankTargetIsTreatedAsNull() {
        ...
        DispatchResult result = tools.sendMessage("tgt-blank-1", "alice", "status", "msg", null, null, null, null, "", null, null, null, null);
    ...
    void instanceTargetIsStoredAndReturnedInResult() {
        ...
        DispatchResult result = tools.sendMessage("tgt-inst-1", "alice", "status", "msg", null, null, null, null, "instance:bob", null, null, null, null);
    ...
    void capabilityTargetIsStoredAndReturnedInResult() {
        ...
        DispatchResult result = tools.sendMessage("tgt-cap-1", "alice", "command", "msg", null, null, null, null, "capability:code-review", null, null, null, null);
    ...
    void roleTargetIsStoredAndReturnedInResult() {
        ...
        DispatchResult result = tools.sendMessage("tgt-role-1", "alice", "command", "msg", null, null, null, null, "role:reviewer", null, null, null, null);
    ...
    void targetFlowsThroughToCheckMessagesMessageSummary() {
        ...
        tools.sendMessage("tgt-chk-1", "alice", "status", "targeted msg", null, null, null, null, "instance:bob", null, null, null, null);
    ...
    void nullTargetFlowsThroughToCheckMessagesMessageSummary() {
        ...
        tools.sendMessage("tgt-chk-2", "alice", "status", "broadcast msg", null, null, null, null, null, null, null, null, null);
    ...
    void sevenArgOverloadStillWorksWithNullTarget() {
        ...
        DispatchResult result = tools.sendMessage("tgt-compat-1", "alice", "status", "msg", null, null, null, null, null, null, null, null, null);
