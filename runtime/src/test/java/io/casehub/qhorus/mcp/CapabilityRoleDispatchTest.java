...
class CapabilityRoleDispatchTest {
    ...
    void capabilityTargetedMessageVisibleToAgentWithMatchingTag() {
        ...
        tools.sendMessage("crd-cap-1", "sender", "command", "review this", null, null, null, null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedMessageHiddenFromAgentWithoutMatchingTag() {
        ...
        tools.sendMessage("crd-cap-2", "sender", "command", "review this", null, null, null, null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedMessageHiddenFromUnregisteredReader() {
        ...
        tools.sendMessage("crd-cap-3", "sender", "command", "review this", null, null, null, null, "capability:code-review", null, null, null, null);
    ...
    void broadcastMessageVisibleToCapabilityReader() {
        ...
        tools.sendMessage("crd-cap-4", "sender", "status", "broadcast", null, null, null, null, null, null, null, null, null);
    ...
    void roleTargetedMessageVisibleToAllAgentsWithMatchingRoleTag() {
        ...
        tools.sendMessage("crd-role-1", "sender", "command", "needs review", null, null, null, null, "role:reviewer", null, null, null, null);
    ...
    void roleTargetedMessageHiddenFromAgentWithoutRoleTag() {
        ...
        tools.sendMessage("crd-role-2", "sender", "command", "needs review", null, null, null, null, "role:reviewer", null, null, null, null);
    ...
    void agentWithMultipleTagsSeesAllAddressedMessages() {
        ...
        tools.sendMessage("crd-multi-1", "sender", "command", "cap msg", null, null, null, null, "capability:code-review", null, null, null, null);
        tools.sendMessage("crd-multi-1", "sender", "command", "role msg", null, null, null, null, "role:reviewer", null, null, null, null);
        tools.sendMessage("crd-multi-1", "sender", "status", "broadcast", null, null, null, null, null, null, null, null, null);
    ...
    void capabilityTargetedReplyVisibleToAgentWithTag() {
        ...
        DispatchResult parent = tools.sendMessage("crd-rep-1", "alice", "query", "question", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("crd-rep-1", "bob", "response", "answer", null, parent.correlationId(), parent.messageId(), null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedReplyHiddenFromAgentWithoutTag() {
        ...
        tools.register("non-reviewer", "Not a reviewer", List.of("capability:python"), null, null);
        DispatchResult parent = tools.sendMessage("crd-rep-2", "alice", "query", "question", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("crd-rep-2", "bob", "response", "answer", null, parent.correlationId(), parent.messageId(), null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedMessageFoundBySearchForAgentWithTag() {
        ...
        tools.sendMessage("crd-srch-1", "sender", "command", "searchable review request", null, null, null, null, "capability:code-review", null, null, null, null);
    ...
    void capabilityTargetedMessageNotFoundBySearchForAgentWithoutTag() {
        ...
        tools.sendMessage("crd-srch-2", "sender", "command", "searchable review request", null, null, null, null, "capability:code-review", null, null, null, null);
