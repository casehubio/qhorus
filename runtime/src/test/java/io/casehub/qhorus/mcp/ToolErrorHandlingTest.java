...
class ToolErrorHandlingTest {
    ...
    void sendMessage_pausedChannel_throwsIllegalStateException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
                ...
                () -> tools.sendMessage("wrap-test-paused", "inst-1", "status", "hello", null, null, null, null, null, null, null, null, null));
    }
    ...
    void pauseChannel_nonExistentUuid_throwsIllegalArgumentException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(IllegalArgumentException.class, () -> tools.pauseChannel(nonExistentUuid, null));
    }
}
