...
class ArtefactRefsTest {
    ...
    void sendMessageWithArtefactRefsReturnsThemInCheckMessages() {
        ...
        tools.sendMessage("arefs-ch-1", "alice", "status", "message with refs", null, null, null, List.of(uuid1, uuid2), null, null, null, null, null);
    ...
    void sendMessageWithNoArtefactRefsHasEmptyListInMessageSummary() {
        ...
        tools.sendMessage("arefs-ch-2", "alice", "status", "no refs", null, null, null, null, null, null, null, null, null);
    ...
    void sendMessageWithEmptyArtefactRefsListHasEmptyListInSummary() {
        ...
        tools.sendMessage("arefs-ch-3", "alice", "status", "empty refs", null, null, null, List.of(), null, null, null, null, null);
    ...
    void sendMessageResultIncludesArtefactRefs() {
        ...
        DispatchResult result = tools.sendMessage("arefs-ch-4", "alice", "status", "with ref", null, null, null, List.of(uuid), null, null, null, null, null);
    ...
    void artefactRefsAppearsInGetReplies() {
        ...
        DispatchResult request = tools.sendMessage("arefs-ch-5", "alice", "query", "Question?", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("arefs-ch-5", "bob", "response", "Answer with artefact", null, request.correlationId(), request.messageId(), List.of(uuid), null, null, null, null, null);
    ...
    void artefactRefsAppearsInSearchMessages() {
        ...
        tools.sendMessage("arefs-ch-6", "alice", "status", "analysis complete", null, null, null, List.of(uuid), null, null, null, null, null);
    ...
    void nullArtefactRefsStoredAsNullNotEmptyString() {
        ...
        tools.sendMessage("arefs-ch-7", "alice", "status", "no refs", null, null, null, null, null, null, null, null, null);
