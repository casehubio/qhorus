...
class LastWriteSemanticTest {
    ...
    void lastWriteFirstMessageSucceeds() {
        ...
        DispatchResult result = tools.sendMessage("lw-1", "alice", "status", "v1", null, null, null, null, null, null, null, null, null);
    ...
    void lastWriteSameSenderOverwritesInPlace() {
        ...
        DispatchResult first = tools.sendMessage("lw-2", "alice", "status", "v1", null, null, null, null, null, null, null, null, null);

        DispatchResult second = tools.sendMessage("lw-2", "alice", "status", "v2", null, null, null, null, null, null, null, null, null);
    ...
    void lastWriteChannelHasExactlyOneMessageAfterMultipleWrites() {
        ...
        tools.sendMessage("lw-3", "alice", "status", "v1", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("lw-3", "alice", "status", "v2", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("lw-3", "alice", "status", "v3", null, null, null, null, null, null, null, null, null);
    ...
    void lastWriteOverwriteUpdatesMessageType() {
        ...
        tools.sendMessage("lw-6", "alice", "status", "initial state", null, null, null, null, null, null, null, null, null);

        // Overwrite with a different type — should be reflected in the stored message
        DispatchResult overwrite = tools.sendMessage("lw-6", "alice", "command", "updated", null, null, null, null, null, null, null, null, null);
    ...
    void lastWriteOverwriteUpdatesCorrelationId() {
        ...
        tools.sendMessage("lw-7", "alice", "status", "v1", null, "corr-original", null, null, null, null, null, null, null);

        DispatchResult overwrite = tools.sendMessage("lw-7", "alice", "status", "v2", null, "corr-updated", null, null, null, null, null, null, null);
    ...
    void appendChannelAllowsMultipleSendersUnaffected() {
        ...
        DispatchResult m1 = tools.sendMessage("append-lw", "alice", "status", "first", null, null, null, null, null, null, null, null, null);
        DispatchResult m2 = tools.sendMessage("append-lw", "bob", "status", "second", null, null, null, null, null, null, null, null, null);
