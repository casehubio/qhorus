...
class ChannelWritePermissionsTest {
    ...
    void openChannelWithNoAclAllowsAnyWriter() {
        tools.createChannel("wp-open-1", "Open channel", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void openChannelDetailHasNullAllowedWriters() {
        ChannelDetail detail = tools.createChannel("wp-open-2", "Open", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void listedInstanceIdCanSend() {
        tools.createChannel("wp-iid-1",  "ACL by ID",  null,  null,  "alice,bob",  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void secondListedInstanceIdCanSend() {
        tools.createChannel("wp-iid-2",  "ACL by ID",  null,  null,  "alice,bob",  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void unlistedSenderRejectedWithClearError() {
        tools.createChannel("wp-iid-3",  "ACL by ID",  null,  null,  "alice,bob",  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void allowedWritersEntriesAreStripped() {
        ...
        tools.createChannel("wp-iid-4",  "ACL trimmed",  null,  null,  " alice , bob ",  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void senderWithMatchingCapabilityTagCanWrite() {
        tools.createChannel("wp-cap-1", "ACL by capability", null, null, "capability:code-review", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void senderWithoutMatchingCapabilityTagIsRejected() {
        tools.createChannel("wp-cap-2", "ACL by capability", null, null, "capability:code-review", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void unregisteredSenderCannotMatchCapabilityTag() {
        tools.createChannel("wp-cap-3", "ACL by capability", null, null, "capability:code-review", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void senderWithMatchingRoleTagCanWrite() {
        tools.createChannel("wp-role-1", "ACL by role", null, null, "role:reviewer", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void senderWithWrongRoleTagIsRejected() {
        tools.createChannel("wp-role-2", "ACL by role", null, null, "role:reviewer", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void mixedAclAcceptsInstanceIdAndCapabilityTag() {
        tools.createChannel("wp-mix-1",  "Mixed ACL",  null,  null,  "alice,capability:code-review",  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void mixedAclRejectsNonMatchingSender() {
        tools.createChannel("wp-mix-2",  "Mixed ACL",  null,  null,  "alice,capability:code-review",  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void eventMessagesPassAclCheck() {
        ...
        tools.createChannel("wp-evt-1", "ACL channel", null, null, "alice", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void setChannelWritersAppliesAclToExistingChannel() {
        tools.createChannel("wp-scw-1", "Initially open", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void setChannelWritersToNullOrBlankClearsAcl() {
        tools.createChannel("wp-scw-2", "Starts with ACL", null, null, "alice", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void createChannelDetailIncludesAllowedWriters() {
        ChannelDetail detail = tools.createChannel("wp-det-1",  "With ACL",  null,  null,  "alice,bob",  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void listChannelsIncludesAllowedWriters() {
        tools.createChannel("wp-det-2", "ACL channel", null, null, "carol", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void findChannelIncludesAllowedWriters() {
        tools.createChannel("wp-det-3", "Searchable ACL", null, null, "dave", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void e2eThreeAgentsMixedAcl() {
        ...
        tools.createChannel("wp-e2e-1",  "Restricted channel",  "APPEND",  null,  "alice-agent,bob-agent",  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void e2eCapabilityBasedAcl() {
        tools.createChannel("wp-e2e-2", "Review channel", "COLLECT", null, "capability:reviewer", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void e2eAclAndPauseAreIndependent() {
        tools.createChannel("wp-e2e-3", "Test", "APPEND", null, "alice", null, null, null, null, null, null, null, null, null, null, null);
