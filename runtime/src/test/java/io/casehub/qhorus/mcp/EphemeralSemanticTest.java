...
class EphemeralSemanticTest {
    ...
    void ephemeralMessageDeliveredOnFirstRead() {
        ...
        tools.sendMessage("eph-1", "alice", "status", "routing hint", null, null, null, null, null, null, null, null, null);
    ...
    void ephemeralSecondReadReturnsEmpty() {
        ...
        tools.sendMessage("eph-2", "alice", "status", "transient context", null, null, null, null, null, null, null, null, null);
    ...
    void ephemeralNewWriteAfterReadIsDeliveredOnNextRead() {
        ...
        tools.sendMessage("eph-3", "alice", "status", "first hint", null, null, null, null, null, null, null, null, null);
        tools.checkMessages("eph-3", 0L, 10, null, null, null); // Consume first

        tools.sendMessage("eph-3", "alice", "status", "second hint", null, null, null, null, null, null, null, null, null);
    ...
    void ephemeralMultipleMessagesAllConsumedOnFirstRead() {
        ...
        tools.sendMessage("eph-4", "alice", "status", "hint-1", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("eph-4", "bob", "status", "hint-2", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("eph-4", "carol", "status", "hint-3", null, null, null, null, null, null, null, null, null);
    ...
    void ephemeralLimitOnlyDeletesDeliveredMessages() {
        ...
        tools.sendMessage("eph-5", "alice", "status", "msg-1", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("eph-5", "alice", "status", "msg-2", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("eph-5", "alice", "status", "msg-3", null, null, null, null, null, null, null, null, null);
    ...
    void appendChannelUnaffectedByEphemeralLogic() {
        ...
        tools.sendMessage("append-eph", "alice", "status", "persistent", null, null, null, null, null, null, null, null, null);
