...
class ChannelAllowedTypesTest {
    ...
    void createChannel_withAllowedTypes_roundtripsInDetail() {
        ChannelDetail detail = tools.createChannel(
                ...
                null,  null,  null,  null,  null,  "QUERY,COMMAND",  null, null, null,  null,  null,  null,  null);
    ...
    void createChannel_nullAllowedTypes_detailShowsNull() {
        ChannelDetail detail = tools.createChannel("open-" + System.nanoTime(), "Open channel", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void createChannel_existingFourParamOverload_detailShowsNull() {
        ChannelDetail detail = tools.createChannel("legacy-" + System.nanoTime(), "Legacy call", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        assertNull(detail.allowedTypes());
    }
    ...
    void sendMessage_rejectsDisallowedType_serverSide() {
        ...
        tools.createChannel(name, "Telemetry only", "APPEND", null, null, null, null, null, "EVENT", null, null, null, null, null, null, null);
    ...
    void sendMessage_openChannel_permitsAllTypes() {
        ...
        tools.createChannel(name, "Open", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null);
