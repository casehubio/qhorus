...
class ChannelAdminRoleTest {
    ...
    void openChannelWithNoAdminListAllowsAnyCallerToPause() {
        tools.createChannel("ar-open-1", "Open", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void openChannelWithNoAdminListAllowsAnyCallerToResume() {
        tools.createChannel("ar-open-2", "Open", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void openChannelWithNoAdminListAllowsAnyCallerToForceRelease() {
        tools.createChannel("ar-open-3",  "Open",  "BARRIER",  "alice,bob",  null,  null,  null,  null,  null,  null, null,  null,  null,  null,  null);
    ...
    void openChannelWithNoAdminListAllowsAnyCallerToClear() {
        tools.createChannel("ar-open-4", "Open", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void createChannelDetailHasNullAdminInstances() {
        ChannelDetail detail = tools.createChannel("ar-open-5", "Open", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void nullCallerIdBypasesAdminCheckForOpenChannel() {
        tools.createChannel("ar-null-1", "Open", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void listedAdminCanPauseChannel() {
        tools.createChannel("ar-admin-1", "Admin gated", null, null, null, "alice-admin", null, null, null, null, null, null, null, null, null);
    ...
    void listedAdminCanResumeChannel() {
        tools.createChannel("ar-admin-2", "Admin gated", null, null, null, "alice-admin", null, null, null, null, null, null, null, null, null);
    ...
    void listedAdminCanForceReleaseChannel() {
        tools.createChannel("ar-admin-3",  "Admin gated",  "BARRIER",  "alice,bob",  null,  "alice-admin",  null,  null,  null,  null, null,  null,  null,  null,  null);
    ...
    void listedAdminCanClearChannel() {
        tools.createChannel("ar-admin-4", "Admin gated", null, null, null, "alice-admin", null, null, null, null, null, null, null, null, null);
    ...
    void multipleAdminsAnyOneCanManage() {
        tools.createChannel("ar-admin-5",  "Multi-admin",  null,  null,  null,  "alice-admin,bob-admin",  null,  null,  null,  null, null,  null,  null,  null,  null);
    ...
    void nonAdminCannotPauseChannel() {
        tools.createChannel("ar-deny-1", "Admin gated", null, null, null, "alice-admin", null, null, null, null, null, null, null, null, null);
    ...
    void nonAdminCannotResumeChannel() {
        tools.createChannel("ar-deny-2", "Admin gated", null, null, null, "alice-admin", null, null, null, null, null, null, null, null, null);
    ...
    void nonAdminCannotForceReleaseChannel() {
        tools.createChannel("ar-deny-3",  "Admin gated",  "BARRIER",  "alice,bob",  null,  "alice-admin",  null,  null,  null,  null, null,  null,  null,  null,  null);
    ...
    void nonAdminCannotClearChannel() {
        tools.createChannel("ar-deny-4", "Admin gated", null, null, null, "alice-admin", null, null, null, null, null, null, null, null, null);
    ...
    void setChannelAdminsAppliesAdminListToExistingChannel() {
        tools.createChannel("ar-sca-1", "Open initially", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void setChannelAdminsToNullClearsAdminList() {
        tools.createChannel("ar-sca-2", "Admin gated", null, null, null, "alice-admin", null, null, null, null, null, null, null, null, null);
    ...
    void createChannelDetailIncludesAdminInstances() {
        ChannelDetail detail = tools.createChannel("ar-det-1", "Admin channel", null, null, null, "carol-admin", null, null, null, null, null, null, null, null, null);
    ...
    void listChannelsIncludesAdminInstances() {
        tools.createChannel("ar-det-2", "Admin channel", null, null, null, "dave-admin", null, null, null, null, null, null, null, null, null);
    ...
    void allowedWritersAndAdminInstancesAreIndependent() {
        ...
        tools.createChannel("ar-ind-1", "Dual ACL", null, null, "alice", "bob-admin", null, null, null, null, null, null, null, null, null);
    ...
    void e2eOnlyAdminCanManageChannel() {
        tools.createChannel("ar-e2e-1", "Governed channel", "APPEND", null, null, "admin-agent", null, null, null, null, null, null, null, null, null);
    ...
    void e2eAdminCanPauseResumeCycleWhileNonAdminsAreBlocked() {
        tools.createChannel("ar-e2e-2", "Cycle test", "APPEND", null, null, "admin-agent", null, null, null, null, null, null, null, null, null);
