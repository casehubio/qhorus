...
class ForceReleaseTest {
    ...
    void forceReleaseBarrierDeliversMessagesBeforeAllContributorsWrite() {
        tools.createChannel("fr-barrier-1",  "Test",  "BARRIER",  "alice,bob",  null,  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void forceReleaseBarrierPostsAuditEvent() {
        tools.createChannel("fr-barrier-2",  "Test",  "BARRIER",  "alice,bob",  null,  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void forceReleaseEmptyBarrierReturnsZeroMessages() {
        tools.createChannel("fr-barrier-3",  "Test",  "BARRIER",  "alice,bob",  null,  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
        // No messages written
    ...
    void forceReleaseBarrierClearsChannelSoSubsequentCheckMessagesIsEmpty() {
        tools.createChannel("fr-barrier-4",  "Test",  "BARRIER",  "alice,bob",  null,  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void forceReleaseCollectDeliversAccumulatedMessages() {
        tools.createChannel("fr-collect-1", "Test", "COLLECT", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void forceReleaseCollectClearsChannelAfterDelivery() {
        tools.createChannel("fr-collect-2", "Test", "COLLECT", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void forceReleaseAppendChannelThrows() {
        tools.createChannel("fr-append-1", "Test", "APPEND", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void forceReleaseEphemeralChannelThrows() {
        tools.createChannel("fr-ephemeral-1", "Test", "EPHEMERAL", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void forceReleaseLastWriteChannelThrows() {
        tools.createChannel("fr-lw-1", "Test", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void integrationBarrierStuckThenForceReleased() {
        tools.createChannel("fr-int-1",  "Test",  "BARRIER",  "alice,bob,carol",  null,  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void e2eHumanForceReleasesStuckBarrier() {
        ...
        tools.createChannel("fr-e2e-1",  "Code Review",  "BARRIER",  "reviewer-1,reviewer-2",  null,  null,  null,  null,  null,  null, null, null,  null,  null,  null,  null);
    ...
    void e2eHumanForceReleasesStuckCollect() {
        tools.createChannel("fr-e2e-2", "Results", "COLLECT", null, null, null, null, null, null, null, null, null, null, null, null, null);
