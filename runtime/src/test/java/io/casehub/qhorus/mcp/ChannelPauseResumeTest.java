...
class ChannelPauseResumeTest {
    ...
    void sendMessageOnResumedChannelSucceeds() {
        ...
        assertDoesNotThrow(
                () -> tools.sendMessage("pr-send-2", "alice", "status", "hello", null, null, null, null, null, null, null, null, null));
    }
    ...
    void checkMessagesOnPausedChannelReturnsEmptyWithStatus() {
        ...
        tools.sendMessage("pr-check-1", "alice", "status", "before pause", null, null, null, null, null, null, null, null, null);
    ...
    void checkMessagesOnResumedChannelReturnsMessages() {
        ...
        tools.sendMessage("pr-check-2", "alice", "status", "before pause", null, null, null, null, null, null, null, null, null);
    ...
    void fullPauseResumeCycle() {
        ...
        assertDoesNotThrow(() -> tools.sendMessage("pr-cycle-1", "alice", "status", "msg1", null, null, null, null, null, null, null, null, null));
        ...
        assertDoesNotThrow(() -> tools.sendMessage("pr-cycle-1", "alice", "status", "msg3", null, null, null, null, null, null, null, null, null));
    ...
    void e2eMultipleAgentsBlockedByPause() {
        ...
        tools.sendMessage("pr-e2e-1", "alice-agent", "command", "alice work", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("pr-e2e-1", "bob-agent", "status", "bob work", null, null, null, null, null, null, null, null, null);
        ...
        assertDoesNotThrow(() -> tools.sendMessage("pr-e2e-1", "alice-agent", "status", "alice resumes", null, null, null, null, null, null, null, null, null));
        assertDoesNotThrow(() -> tools.sendMessage("pr-e2e-1", "bob-agent", "status", "bob resumes", null, null, null, null, null, null, null, null, null));
