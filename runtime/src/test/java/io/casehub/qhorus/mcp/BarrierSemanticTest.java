...
class BarrierSemanticTest {
    ...
    void barrierBlocksWhenNoContributorsHaveWritten() {
        tools.createChannel("bar-1", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void barrierBlocksWhenOnlySomeContributorsHaveWritten() {
        tools.createChannel("bar-2", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void barrierReleasesWhenAllContributorsHaveWritten() {
        tools.createChannel("bar-3", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void barrierClearsAndResetsAfterRelease() {
        tools.createChannel("bar-4", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void barrierNonContributorWriteDoesNotTriggerRelease() {
        tools.createChannel("bar-5", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void barrierNewCycleRequiresAllContributorsAgain() {
        tools.createChannel("bar-6", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void barrierEventMessageFromContributorDoesNotCountTowardRelease() {
        tools.createChannel("bar-7", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void barrierWithNullContributorsBlocksPermanently() {
        ...
        tools.createChannel("bar-8", "BARRIER channel", "BARRIER", null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void barrierReleaseIncludesNonContributorMessages() {
        ...
        tools.createChannel("bar-9", "BARRIER channel", "BARRIER", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
    ...
    void appendChannelUnaffectedByBarrierLogic() {
        tools.createChannel("append-bar", "APPEND channel", "APPEND", "alice,bob", null, null, null, null, null, null, null, null, null, null, null);
