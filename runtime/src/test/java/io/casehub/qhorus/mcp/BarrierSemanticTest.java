...
class BarrierSemanticTest {
    ...
    void barrierBlocksWhenOnlySomeContributorsHaveWritten() {
        ...
        tools.sendMessage("bar-2", "alice", "status", "alice ready", null, null, null, null, null, null, null, null, null);
    ...
    void barrierReleasesWhenAllContributorsHaveWritten() {
        ...
        tools.sendMessage("bar-3", "alice", "status", "alice ready", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("bar-3", "bob", "status", "bob ready", null, null, null, null, null, null, null, null, null);
    ...
    void barrierClearsAndResetsAfterRelease() {
        ...
        tools.sendMessage("bar-4", "alice", "status", "ready", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("bar-4", "bob", "status", "ready", null, null, null, null, null, null, null, null, null);
    ...
    void barrierNonContributorWriteDoesNotTriggerRelease() {
        ...
        tools.sendMessage("bar-5", "alice", "status", "alice ready", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("bar-5", "carol", "status", "observer writes", null, null, null, null, null, null, null, null, null); // not a contributor
    ...
    void barrierNewCycleRequiresAllContributorsAgain() {
        ...
        tools.sendMessage("bar-6", "alice", "status", "cycle-1", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("bar-6", "bob", "status", "cycle-1", null, null, null, null, null, null, null, null, null);
        tools.checkMessages("bar-6", 0L, 10, null, null, null); // Release and reset

        // Cycle 2: only alice writes — bob still pending
        tools.sendMessage("bar-6", "alice", "status", "cycle-2", null, null, null, null, null, null, null, null, null);
    ...
    void barrierEventMessageFromContributorDoesNotCountTowardRelease() {
        ...
        tools.sendMessage("bar-7", "alice", "event", null, null, null, null, null, null, null, null, null, null);
        tools.sendMessage("bar-7", "bob", "status", "bob ready", null, null, null, null, null, null, null, null, null);
    ...
    void barrierWithNullContributorsBlocksPermanently() {
        ...
        tools.sendMessage("bar-8", "alice", "status", "ready", null, null, null, null, null, null, null, null, null);
    ...
    void barrierReleaseIncludesNonContributorMessages() {
        ...
        tools.sendMessage("bar-9", "alice", "status", "alice ready", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("bar-9", "carol", "status", "observer note", null, null, null, null, null, null, null, null, null); // not a contributor
        tools.sendMessage("bar-9", "bob", "status", "bob ready", null, null, null, null, null, null, null, null, null);
    ...
    void appendChannelUnaffectedByBarrierLogic() {
        ...
        tools.sendMessage("append-bar", "alice", "status", "message", null, null, null, null, null, null, null, null, null);
