...
class ApprovalGateTest {
    ...
    void respondToApprovalCreatesResponseMessageInChannel() {
        tools.createChannel("ag-respond-1", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void respondToApprovalSenderIsHuman() {
        tools.createChannel("ag-respond-2", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void respondToApprovalSetsCorrelationId() {
        tools.createChannel("ag-respond-3", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void listPendingCommitmentsShowsRegisteredApproval() {
        tools.createChannel("ag-list-1", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void listPendingCommitmentsResolvesChannelId() {
        tools.createChannel("ag-list-2", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void listPendingCommitmentsShowsExpiresAt() {
        tools.createChannel("ag-list-3", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void listPendingCommitmentsOrdersByExpiresAtAscending() {
        tools.createChannel("ag-list-4", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    void requestApprovalFindsPreSeededResponse() {
        tools.createChannel("ag-req-1", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void requestApprovalCreatesRequestMessageInChannel() {
        tools.createChannel("ag-req-2", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void requestApprovalUsesProvidedCorrelationId() {
        tools.createChannel("ag-req-3", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void requestApprovalTimesOutGracefully() {
        tools.createChannel("ag-req-4", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void e2eAgentRequestsHumanApproves() {
        tools.createChannel("ag-e2e-1", "Human Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void e2eRequestApprovalThenRespondReturnsToCaller() {
        tools.createChannel("ag-e2e-2", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId = UUID.randomUUID().toString();
    ...
    void e2eMultiplePendingCommitmentsDiscoveredAndAnswered() {
        tools.createChannel("ag-e2e-3", "Approvals", null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        String corrId1 = UUID.randomUUID().toString();
        String corrId2 = UUID.randomUUID().toString();
