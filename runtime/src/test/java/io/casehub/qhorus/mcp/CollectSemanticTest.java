...
class CollectSemanticTest {
    ...
    void collectDeliversAllContributionsAtomically() {
        ...
        tools.sendMessage("col-1", "alice", "status", "alice's finding", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("col-1", "bob", "status", "bob's finding", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("col-1", "carol", "status", "carol's finding", null, null, null, null, null, null, null, null, null);
    ...
    void collectClearsChannelAfterDelivery() {
        ...
        tools.sendMessage("col-2", "alice", "status", "contribution", null, null, null, null, null, null, null, null, null);
    ...
    void collectIgnoresAfterIdCursorDeliversAll() {
        ...
        DispatchResult m1 = tools.sendMessage("col-3", "alice", "status", "first", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("col-3", "bob", "status", "second", null, null, null, null, null, null, null, null, null);
    ...
    void collectNewCycleAfterClear() {
        ...
        tools.sendMessage("col-4", "alice", "status", "cycle-1 data", null, null, null, null, null, null, null, null, null);
        tools.checkMessages("col-4", 0L, 10, null, null, null); // Clear cycle 1

        // New writes start cycle 2
        tools.sendMessage("col-4", "bob", "status", "cycle-2 data", null, null, null, null, null, null, null, null, null);
    ...
    void collectExcludesEventMessages() {
        ...
        tools.sendMessage("col-5", "alice", "status", "visible", null, null, null, null, null, null, null, null, null);
        tools.sendMessage("col-5", "system", "event", null, null, null, null, null, null, null, null, null, null);
        tools.sendMessage("col-5", "bob", "status", "also visible", null, null, null, null, null, null, null, null, null);
    ...
    void appendChannelUnaffectedByCollectLogic() {
        ...
        tools.sendMessage("append-col", "alice", "status", "persistent", null, null, null, null, null, null, null, null, null);
