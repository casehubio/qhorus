...
class LastWriteArtefactRefsTest {
    ...
    void lastWriteOverwriteReplacesArtefactRefsNotAccumulatesThem() {
        ...
        tools.sendMessage("lw-refs-replace", "alice", "status", "v1", null, null, null, List.of(ref1.artefactId().toString(), ref2.artefactId().toString()), null, null, null, null, null);

        // Overwrite: attach only ref3 — ref1 and ref2 must be GONE
        DispatchResult overwrite = tools.sendMessage("lw-refs-replace", "alice", "status", "v2", null, null, null, List.of(ref3.artefactId().toString()), null, null, null, null, null);
    ...
    void lastWriteOverwriteWithNullRefsClearsStoredRefs() {
        ...
        tools.sendMessage("lw-refs-clear", "alice", "status", "v1", null, null, null, List.of(ref.artefactId().toString()), null, null, null, null, null);

        // Overwrite with null refs — stored refs must be cleared
        DispatchResult overwrite = tools.sendMessage("lw-refs-clear", "alice", "status", "v2", null, null, null, null, null, null, null, null, null);
    ...
    void lastWriteOverwriteWithUnknownArtefactRefIsRejected() {
        ...
        tools.sendMessage("lw-refs-bad-overwrite", "alice", "status", "v1", null, null, null, null, null, null, null, null, null);
    ...
    void lastWriteOverwriteWithEmptyRefsListClearsStoredRefs() {
        ...
        // First write: attach ref
        tools.sendMessage("lw-refs-empty-list", "alice", "status", "v1", null, null, null, List.of(ref.artefactId().toString()), null, null, null, null, null);

        // Overwrite with empty list — stored refs must be cleared
        DispatchResult overwrite = tools.sendMessage("lw-refs-empty-list", "alice", "status", "v2", null, null, null, List.of(), null, null, null, null, null);
