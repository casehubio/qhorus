...
class LastWriteArtefactRefsTest {
    ...
    void lastWriteOverwriteReplacesArtefactRefsNotAccumulatesThem() {
        helper.createChannel("lw-refs-replace", "LAST_WRITE artefact refs", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ArtefactDetail ref1 = helper.shareArtefact("lw-ref-data-1", "d", "alice", "content1", false, true);
        ArtefactDetail ref2 = helper.shareArtefact("lw-ref-data-2", "d", "alice", "content2", false, true);
        ArtefactDetail ref3 = helper.shareArtefact("lw-ref-data-3", "d", "alice", "content3", false, true);

        // First write: attach ref1 and ref2
        helper.sendMessage("lw-refs-replace", "alice", "status", "v1", null, null, null, List.of(ref1.artefactId().toString(), ref2.artefactId().toString()), null, null, null, null, null);

        // Overwrite: attach only ref3 — ref1 and ref2 must be GONE
        DispatchResult overwrite = helper.sendMessage("lw-refs-replace", "alice", "status", "v2", null, null, null, List.of(ref3.artefactId().toString()), null, null, null, null, null);
        ...
        CheckResult check = helper.checkMessages("lw-refs-replace", 0L, 10, null, null, null);
        assertEquals(1, check.size());
        assertEquals(1, check.get(0).artefactRefs().size(),
                "checkMessages must show only 1 artefact ref after LAST_WRITE overwrite");
        assertEquals(ref3.artefactId().toString(),
                check.get(0).artefactRefs().get(0).uri());
    }
    ...
    void lastWriteOverwriteWithNullRefsClearsStoredRefs() {
        helper.createChannel("lw-refs-clear", "LAST_WRITE clear refs", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ArtefactDetail ref = helper.shareArtefact("lw-ref-clear-data", "d", "alice", "content", false, true);

        // First write: attach ref
        helper.sendMessage("lw-refs-clear", "alice", "status", "v1", null, null, null, List.of(ref.artefactId().toString()), null, null, null, null, null);

        // Overwrite with null refs — stored refs must be cleared
        DispatchResult overwrite = helper.sendMessage("lw-refs-clear", "alice", "status", "v2", null, null, null, null, null, null, null, null, null);

        assertTrue(overwrite.artefactRefs().isEmpty(),
                "LAST_WRITE overwrite with null refs must clear the stored artefact refs");

        CheckResult check = helper.checkMessages("lw-refs-clear", 0L, 10, null, null, null);
        assertTrue(check.get(0).artefactRefs().isEmpty(),
    ...
    void lastWriteOverwriteWithUnknownArtefactRefIsRejected() {
        helper.createChannel("lw-refs-bad-overwrite", "LAST_WRITE bad ref test", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);

        // First write succeeds (no refs)
        helper.sendMessage("lw-refs-bad-overwrite", "alice", "status", "v1", null, null, null, null, null, null, null, null, null);

        // Overwrite with a dangling (non-existent) artefact UUID — must be rejected
        String fakeUuid = java.util.UUID.randomUUID().toString();
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> helper.sendMessage("lw-refs-bad-overwrite", "alice", "status", "v2", null, null, null, List.of(fakeUuid), null, null, null, null, null), "LAST_WRITE overwrite with an unknown artefact UUID must be rejected before the write");
        ...
        CheckResult check = helper.checkMessages("lw-refs-bad-overwrite", 0L, 10, null, null, null);
        assertEquals(1, check.size());
        assertEquals("v1", check.get(0).content(),
    ...
    void lastWriteOverwriteWithEmptyRefsListClearsStoredRefs() {
        helper.createChannel("lw-refs-empty-list", "LAST_WRITE empty list", "LAST_WRITE", null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ArtefactDetail ref = helper.shareArtefact("lw-ref-empty-data", "d", "alice", "content", false, true);

        // First write: attach ref
        helper.sendMessage("lw-refs-empty-list", "alice", "status", "v1", null, null, null, List.of(ref.artefactId().toString()), null, null, null, null, null);

        // Overwrite with empty list — stored refs must be cleared
        DispatchResult overwrite = helper.sendMessage("lw-refs-empty-list", "alice", "status", "v2", null, null, null, List.of(), null, null, null, null, null);
