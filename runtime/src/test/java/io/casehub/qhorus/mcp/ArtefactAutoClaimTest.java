...
class ArtefactAutoClaimTest {
    ...
    void sendMessageWithArtefactRefsAutoClaimsForSender() {
        ...
        tools.sendMessage("autoclaim-1", "claimer-agent", "command", "process this doc", null, null, null, List.of(artId), null, null, null, null, null);
    ...
    void sendMessageWithoutArtefactRefsDoesNotClaim() {
        ...
        tools.sendMessage("autoclaim-2", "no-ref-agent", "status", "no artefacts here", null, null, null, null, null, null, null, null, null);
    ...
    void responseAutoReleasesClaimsFromOriginalQuery() {
        ...
        DispatchResult queryResult = tools.sendMessage("autorel-1", "asker", "query", "what about this doc?", null, null, null, List.of(artId), null, null, null, null, null);
        ...
        tools.sendMessage("autorel-1", "answerer", "response", "here is the answer", null, corrId, queryResult.messageId(), null, null, null, null, null, null);
    ...
    void doneAutoReleasesClaimsFromOriginalCommand() {
        ...
        DispatchResult cmdResult = tools.sendMessage("autorel-2", "commander", "command", "process this", null, null, null, List.of(artId), null, null, null, null, null);
        ...
        tools.sendMessage("autorel-2", "worker", "done", "completed", null, corrId, cmdResult.messageId(), null, null, null, null, null, null);
    ...
    void declineAutoReleasesClaimsFromOriginalQuery() {
        ...
        DispatchResult queryResult = tools.sendMessage("autorel-3", "asker-2", "query", "what about this?", null, null, null, List.of(artId), null, null, null, null, null);
        String corrId = queryResult.correlationId();

        assertFalse(tools.isGcEligible(artId), "artefact should be claimed after QUERY");

        // DECLINE auto-releases
        tools.sendMessage("autorel-3", "decliner", "decline", "cannot help with that", null, corrId, queryResult.messageId(), null, null, null, null, null, null);
    ...
    void failureAutoReleasesClaimsFromOriginalCommand() {
        ...
        DispatchResult cmdResult = tools.sendMessage("autorel-4", "cmd-agent", "command", "do this", null, null, null, List.of(artId), null, null, null, null, null);
        String corrId = cmdResult.correlationId();

        // FAILURE auto-releases
        tools.sendMessage("autorel-4", "fail-agent", "failure", "could not complete", null, corrId, cmdResult.messageId(), null, null, null, null, null, null);
    ...
    void handoffDoesNotAutoReleaseClaims() {
        ...
        DispatchResult cmdResult = tools.sendMessage("autorel-5", "handoff-cmd", "command", "handle this", null, null, null, List.of(artId), null, null, null, null, null);
        String corrId = cmdResult.correlationId();

        assertFalse(tools.isGcEligible(artId), "artefact should be claimed after COMMAND");

        // HANDOFF delegates but does NOT release
        tools.sendMessage("autorel-5", "handoff-agent", "handoff", "passing to someone else", null, corrId, cmdResult.messageId(), null, "instance:someone-else", null, null, null, null);
    ...
    void autoClaimIsIdempotent() {
        ...
        tools.sendMessage("autoclaim-idem", "idem-agent", "status", "first", null, null, null, List.of(artId), null, null, null, null, null);
        tools.sendMessage("autoclaim-idem", "idem-agent", "status", "second", null, null, null, List.of(artId), null, null, null, null, null);
