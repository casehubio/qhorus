...
class SendMessageFanOutTest {
    ...
    @Transactional
    void setUp() {
        tools.createChannel("fanout-1", "test", "append", null, null, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    void deleteChannel_deregistersAllBackends() {
        tools.createChannel("fanout-2", "test2", "append", null, null, null, null, null, null, null, null, null, null, null, null);
        var ch = tools.listChannels().stream()
