...
class CausalTracingScenarioTest {
    ...
    void crossChannelCausalGraph() {
        ...
        helper.createChannel("gov-work", "Work coordination channel", null, null, null,
                null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        helper.createChannel("gov-ops", "Operations execution channel", null, null, null,
                null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        helper.register("agent-coordinator", "Coordinates work", List.of("coordination"), null, null);
        helper.register("agent-analyst", "Performs analysis", List.of("analysis"), null, null);

        // --- Act: COMMAND → HANDOFF → DONE across channels ---
        // 1. Coordinator sends COMMAND on work channel
        DispatchResult command = helper.sendMessage("gov-work", "agent-coordinator", "COMMAND",
        ...
        DispatchResult handoff = helper.sendMessage("gov-work", "agent-coordinator", "HANDOFF",
        ...
        DispatchResult done = helper.sendMessage("gov-ops", "agent-analyst", "DONE",
        ...
        CausalGraph graph = helper.getCausalGraph(corrId, null);
        ...
        String rendered = helper.renderCausalGraph(corrId, null);
        System.out.println("\n=== Scenario 1: Cross-Channel Causal Tracing ===\n");
