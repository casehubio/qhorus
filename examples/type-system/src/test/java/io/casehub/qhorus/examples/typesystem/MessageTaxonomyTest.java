...
class MessageTaxonomyTest {
    ...
    void declineWithoutContentIsRejected() {
        tools.createChannel("ts-decline-empty",  "DECLINE without content",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void failureWithoutContentIsRejected() {
        tools.createChannel("ts-failure-blank",  "FAILURE without content",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        assertThrows(ToolCallException.class,
    ...
    void handoffWithoutTargetIsRejected() {
        tools.createChannel("ts-handoff-notarget",  "HANDOFF without target",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
        assertThrows(ToolCallException.class,
    ...
    void queryAutoGeneratesCorrelationId() {
        tools.createChannel("ts-query-corr",  "QUERY correlation",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void commandAutoGeneratesCorrelationId() {
        tools.createChannel("ts-command-corr",  "COMMAND correlation",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void validDeclineWithReasonIsAccepted() {
        tools.createChannel("ts-decline-ok",  "Valid DECLINE",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
    ...
    void validHandoffWithTargetIsAccepted() {
        tools.createChannel("ts-handoff-ok",  "Valid HANDOFF",  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null);
