...
type: rule
scope: repo
applies_to: "Any @QuarkusTest consumer that both: (1) enables casehub.qhorus.reactive.enabled=true and (2) adds casehub-qhorus-testing as a test dependency"
severity: important
refs:
