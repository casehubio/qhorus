...
public class SpaceService {
    ...
    public Space create(SpaceCreateRequest request) {
        ...
        boolean duplicate = sameName.stream().anyMatch(s ->
                Objects.equals(s.parentSpaceId(), request.parentSpaceId()));
        if (duplicate) {
        ...
        mutationConsumer.accept(new ChannelMutationEvent.SpaceCreated(created.id(), created.name(), created.tenancyId()));
        return created;
    }
    ...
    public void delete(UUID spaceId) {
        ...
        mutationConsumer.accept(new ChannelMutationEvent.SpaceDeleted(spaceId));
    }
    ...
    public Space rename(UUID spaceId, String newName) {
        ...
        mutationConsumer.accept(new ChannelMutationEvent.SpaceRenamed(spaceId, newName));
        return result;
    }
    ...
    public Channel moveChannelToSpace(UUID channelId, UUID spaceId, Integer position) {
        ...
        mutationConsumer.accept(new ChannelMutationEvent.ChannelMoved(channelId, oldSpaceId, spaceId));
        return result;
    }
