...
public enum MessageType {
    ...
    PROPOSE,
    /** Request a decision with evidence. Receiver must RESPONSE with decision+evidence, or DECLINE. Commissive — caller commits to wait. Carries correlation_id. */
    JUDGMENT,
    ...
    public boolean requiresCorrelationId() {
        return this == QUERY || this == COMMAND || this == PROPOSE || this == JUDGMENT;
    }

    /** Whether this type requires non-empty content. */
    public boolean requiresContent() {
        return this == DECLINE || this == FAILURE || this == PROPOSE || this == JUDGMENT;
    }
